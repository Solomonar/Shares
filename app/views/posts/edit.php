...
<div class="card card-body bg-light mt-5">
    ...
    <form action="<?=URLROOT;?>/posts/edit/<?=$data['id'];?>" method="post">
        ...
        <div class="form-group">
            ...
            <span class="span invalid-feedback"><?=$data['title_error']; ?></span>
        </div>

        <div class="form-group">
            <label for="body">Body:<sup>*</sup></label>
            <textarea name="body" class="form-control form-control-lg <?php echo (!empty($data['body_error'])) ? 'is-invalid' : ''?>"><?=$data['body'];?></textarea>
            <span class="span invalid-feedback"><?=$data['body_error']; ?></span>
        </div>
